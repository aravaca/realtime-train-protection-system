...
class StoppingSim:
    ...
    def _need_B5_now(self, v: float, remaining: float) -> bool:
        ...
        if v0_kmh < 60.0:
            ...
            s_ref = self._stopping_distance(2, v)
        elif v0_kmh < 85.0:
            s_ref = self._stopping_distance(3, v)
        elif v0_kmh < 95.0:
            s_ref = self._stopping_distance(4, v)
        else:
            s_ref = self._stopping_distance(5, v)
